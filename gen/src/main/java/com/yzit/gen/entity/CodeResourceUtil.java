...
public class CodeResourceUtil {
	private static final ResourceBundle bundle = ResourceBundle.getBundle("yzit_database");

	private static final ResourceBundle bundlePath = ResourceBundle.getBundle("yzit_config");

	public static String DIVER_NAME = "com.mysql.jdbc.Driver";

	public static String URL = "jdbc:mysql://localhost:3306/portal?useUnicode=true&characterEncoding=UTF-8";
	...
	//项目路径
	public static String projectPath = "sun";
	...
	public static String getProjectPath() {
		...
		String project_path = bundlePath.getString("project_path");
